<?php
/*
Plugin Name: WooCommerce Min/Max Quantity Manager
Description: Custom functionality for validating product quantities in WooCommerce.
Version: 1.0
Author: Tyche Softwares
*/
/*
* Validating the quantity added to the cart
*/
...
* Get the total quantity of the product available in the cart.
*/
function wc_qty_get_cart_qty_with_key( $product_id , $cart_item_key = '' ) {
   global $woocommerce;
   $running_qty = 0; // iniializing quantity to 0
   ...
   */
   ...
   $already_in_cart = wc_qty_get_cart_qty_with_key( $values['product_id'], $cart_item_key );
